...
**Tests**: Test tasks are REQUIRED for any story that adds or changes business logic.
...
- [ ] T004 [P] Configure test runner and coverage reporting (target: 80%+ lines for business logic)
...
- [ ] T011 [P] Add secret handling baseline (.env policy, ignore rules, no hardcoded secrets)
...
- [ ] TXXX [P] Coverage uplift tasks to maintain >=80% business-logic line coverage
- [ ] TXXX [P] Additional unit tests in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Validate no secrets are committed (scan + review)
...
- Commit in meaningful logical groups with descriptive intent-focused messages
